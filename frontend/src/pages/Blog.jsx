...
const Blog = () => {
  ...
  useSeo({
    title: 'Blog',
    description: 'Articles and write-ups on development, tools, and lessons learned.'
  });
    ...
    <div className="relative page-container overflow-hidden">
      ...
      {loading ? (
        ...
        <Reveal className="text-center py-20 glass-card">
          <Newspaper className="w-10 h-10 mx-auto mb-4 text-muted-light dark:text-muted" />
          <p className="text-muted-light dark:text-muted">No articles found.</p>
        </Reveal>
      ) : (
            ...
            {filteredBlogs.map((blog, index) => (
              ...
              >
                {blog.coverImage ? (
                  ...
                  <div className="h-44 bg-accent-gradient flex items-center justify-center">
                    <span className="text-white text-4xl font-bold font-display">{blog.title.charAt(0)}</span>
                  </div>
                )}

                <div className="p-6">
                  <div className="flex items-center flex-wrap gap-3 mb-3 text-xs text-muted-light dark:text-muted">
                  ...
                  <p className="text-muted-light dark:text-muted mb-4 line-clamp-3 text-sm">
