      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="glass-card p-6">
          ...
          <div className="flex flex-col items-center">
            {userProfile?.avatar ? (
              <img
                src={getFileUrl(userProfile.avatar)}
          ...
          <div>
            {userProfile?.resume ? (
              <p className="text-gray-600 dark:text-white/50">
                Current resume uploaded. <a href={getFileUrl(userProfile.resume)} target="_blank" className="text-primary-600 hover:underline">View</a>
              </p>
            ) : (
              <p className="text-gray-600 dark:text-white/50">No resume uploaded yet.</p>
            )}
          </div>
          <label className="btn-secondary flex items-center space-x-2 cursor-pointer">
            <Upload className="w-5 h-5" />
