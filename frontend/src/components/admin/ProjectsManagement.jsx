    ...
    >
      ...
      {loading ? (
        ...
        <div className="glass-card p-12 text-center">
          <p className="text-gray-600 dark:text-white/50 mb-4">No projects found.</p>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-white/[0.06]">
              <tr>
                ...
                <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-white/50 uppercase tracking-wider">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-white/10">
              {projects.map((project) => (
                <tr key={project._id} className="hover:bg-gray-50 dark:hover:bg-white/[0.08]">
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {formData.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-primary-100 dark:bg-accent-violet/15 text-primary-600 dark:text-accent-light rounded-full text-sm flex items-center space-x-2"
                      >
                        <span>{tech}</span>
                        <button
                          type="button"
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {formData.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-3 py-1 bg-gray-100 dark:bg-white/[0.06] text-gray-700 dark:text-white/70 rounded-full text-sm flex items-center space-x-2"
                      >
                        <span>#{tag}</span>
                        <button
                          type="button"
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="featured" className="text-sm text-gray-700 dark:text-white/70">
                    Featured Project
                  </label>
                </div>
