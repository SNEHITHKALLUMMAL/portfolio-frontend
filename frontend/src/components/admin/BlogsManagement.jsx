    ...
    >
      ...
      {loading ? (
        ...
        <div className="glass-card p-12 text-center">
          <p className="text-gray-600 dark:text-white/50 mb-4">No blogs found.</p>
        ...
        <div className="glass-card overflow-hidden overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-white/10">
              {blogs.map((blog) => (
                <tr key={blog._id} className="hover:bg-gray-50 dark:hover:bg-white/[0.08]">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center space-x-1 text-gray-600 dark:text-white/50">
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="bg-white dark:bg-white/[0.04] rounded-lg">
                    <ReactQuill
