    ...
    >
      ...
      {loading ? (
        ...
        <div className="glass-card p-12 text-center">
          <p className="text-gray-600 dark:text-white/50 mb-4">No skills found.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {displaySkills.map((skill) => (
            ...
            >
              ...
              <span className="px-2 py-1 bg-primary-100 dark:bg-accent-violet/15 text-primary-600 dark:text-accent-light rounded-full text-xs mb-4 inline-block">
                {skill.category}
              </span>
              
              <div className="mt-4">
                <div className="flex justify-between text-sm mb-1">
                  <span className="text-gray-600 dark:text-white/50">Proficiency</span>
