...
const MessagesManagement = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'archived':
        return 'bg-gray-100 dark:bg-white/[0.06] text-gray-600 dark:text-white/50';
      default:
        return 'bg-gray-100 dark:bg-white/[0.06] text-gray-600 dark:text-white/50';
    }
  };
    ...
    >
      ...
      {loading ? (
        ...
        <div className="glass-card p-12 text-center">
          ...
          <p className="text-gray-600 dark:text-white/50">No messages found.</p>
        </div>
      ) : (
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-white/10">
              {contacts.map((contact) => (
                <tr
                  key={contact._id}
                  className={`hover:bg-gray-50 dark:hover:bg-white/[0.08] cursor-pointer ${
                ...
                >
                  <td className="px-6 py-4">
                    <div>
                      ...
                      <div className="text-sm text-gray-500 dark:text-white/50">{contact.email}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-600 dark:text-white/50">
                ...
                <button
                  ...
                  className="p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-white/[0.08]"
                >
                  ×
                </button>
              </div>
